var UltimateLoader=UltimateLoader||{};!function(e){"use strict";function a(e){if(!(e.length<=0)){for(var a=[],t="",o=0;o<e.length;o++){t=e[o];var n=l(t);n&&"mtl"===n.ext&&(E=n)}return a}}function t(e){for(var a,t={},o=0;o<e.length;o++)t=e[o],Array.isArray(t)||(t instanceof THREE.Scene?g=t:a=t);return a}function o(){this.count=0,this.complete=!1,this.size=0}function n(e,a,t,o){if(r(e,o),g.add(o),this.count++,this.count==this.size){for(var n in a)a[n]=o;this.complete=!0,t()}}function r(e,a){for(var t in e)for(var o=0;o<p.length;o++)if(p[o]==t){var n=e[t].split(" ");console.log(n),a[t].set(parseFloat(n[0]),parseFloat(n[1]),parseFloat(n[2]))}}function i(e){switch(e.ext){case"obj":s(e);break;case"json":c(e);break;case"dae":u(e);break;case"gltf":f(e);break;case"glb":f(e);break;case"fbx":loadFBX(e);break;case"drc":loadDRACO(e);break;case"png":d(e);break;case"jpg":d(e);break;case"jpeg":d(e);break;default:console.log("UltimateLoader: File extension -"+e.ext+"- not recognized! Object -"+e.name+"- did not load."),dequeue()}}function l(e){var a=e.slice(0,e.lastIndexOf("/")+1);if(""===a||null===a||"undefined"===a)return!1;var t=e.substr(e.lastIndexOf("/")+1),o=t.split("."),n=o[0],r=o[o.length-1].toLowerCase(),i={name:n,ext:r,baseUrl:a,url:e};return i}function s(e){var a=e.name+".obj",t=e.name+".mtl",o=e.baseUrl;if(e.model.mtl){var n=l(e.model.mtl);n&&(t=n.name+".mtl",o=n.baseUrl)}else E&&(t=E.name+".mtl",o=E.baseUrl);var r=new THREE.MTLLoader;r.setPath(o),r.setTexturePath?r.setTexturePath(o):r.setBaseUrl(o),r.setCrossOrigin(h),r.load(t,function(t){t.preload();var o=new THREE.OBJLoader;o.setMaterials(t),o.setPath(e.baseUrl),o.load(a,function(a){e.object=a,v(e)},b,m)})}function c(e){var a=new THREE.ObjectLoader;a.load(e.url,function(a){e.object=a,v(e)},b,m)}function u(e){var a=new THREE.ColladaLoader;a.load(e.url,function(a){var t=a.scene;e.object=t,v(e)},b,m)}function d(a){var t=new THREE.TextureLoader;t.load(a.url,function(t){var o=t;if(e.loadImagesOnPlane){var n=t.image.naturalHeight/t.image.naturalWidth*e.imageSize,r=new THREE.PlaneGeometry(e.imageSize,n,e.imageSize),i=new THREE.MeshBasicMaterial({map:t,side:THREE.DoubleSide}),l=new THREE.Mesh(r,i);o=l}a.object=o,v(a)},b,m)}function f(e){var a=new THREE.GLTFLoader;a.load(e.url,function(a){var t=a.scene;e.object=t,v(e)},b,m)}function b(e){}function m(e){console.log("There was an error loading your object")}function v(e){console.log("UltimateLoader: Object "+e.name+" loaded!"),e.callback(e.object)}var E=!1,g=!1,h="anonymous",p=["position","rotation","scale"];e.imageSize=32,e.loadImagesOnPlane=!1,e.load=function(){for(var e=[],n=[],r=0;r<arguments.length;r++)if("string"==typeof arguments[r])e.push(arguments[r]);else if("object"==typeof arguments[r])for(var i in arguments[r])n.push(arguments[r]);a(e);var l=t(n);return new Promise(function(e,a){var t=new o;t.load(l,function(){t.complete?e():a(Error("It broke"))})})},o.prototype.load=function(e,a){this.size=Object.size(e);for(var t in e){var o=e[t],r=o.url,s=l(r);s?(s.model=o,s.callback=n.bind(this,o,e,a),i(s)):console.error("UltimateLoader: "+t+" failed to load as it must pass a valid url")}},Object.size=function(e){var a,t=0;for(a in e)e.hasOwnProperty(a)&&t++;return t}}(UltimateLoader),THREE.FileLoader=THREE.FileLoader||THREE.XHRLoader;
