var UltimateLoader=UltimateLoader||{};!function(e){"use strict";function a(e,a){g.push([e,a])}function n(){if(m>g.length-1)return g=[],void(m=0);var e=g[m];m++,o(e)}function t(){0==m&&n()}function o(e,a,t){var t=t||null,o=r(e);switch(o.url=e,o.callback=a,t!==!1&&(o.i=t),o.ext){case"obj":l(o);break;case"json":i(o);break;case"dae":c(o);break;case"gltf":s(o);break;case"fbx":d(o);break;case"png":u(o);break;case"jpg":u(o);break;case"jpeg":u(o);break;default:console.log("UltimateLoader: File extension -"+o.ext+"- not recognized! Object -"+o.name+"- did not load."),n()}}function r(e){var a=e.slice(0,e.lastIndexOf("/")+1),n=e.substr(e.lastIndexOf("/")+1),t=n.split("."),o=t[0],r=t[t.length-1].toLowerCase(),l={name:o,ext:r,baseUrl:a};return l}function l(e){var a=e.name+".obj",n=e.name+".mtl",t=new THREE.MTLLoader;t.setPath(e.baseUrl),t.setTexturePath?t.setTexturePath(e.baseUrl):t.setBaseUrl(e.baseUrl),t.setCrossOrigin(v),t.load(n,function(n){n.preload();var t=new THREE.OBJLoader;t.setMaterials(n),t.setPath(e.baseUrl),t.load(a,function(a){a.traverse(function(e){e instanceof THREE.Mesh&&(e.material.side=THREE.DoubleSide)}),e.object=a,E(e)},b,f)})}function i(e){var a=new THREE.ObjectLoader;a.load(e.url,function(a){e.object=a,E(e)},b,f)}function c(e){var a=new THREE.ColladaLoader;a.load(e.url,function(a){var n=a.scene;e.object=n,E(e)},b,f)}function u(a){var n=new THREE.TextureLoader;n.load(a.url,function(n){var t=n;if(e.loadImagesOnPlane){var o=n.image.naturalHeight/n.image.naturalWidth*e.imageSize,r=new THREE.PlaneGeometry(e.imageSize,o,e.imageSize),l=new THREE.MeshBasicMaterial({map:n,side:THREE.DoubleSide}),i=new THREE.Mesh(r,l);t=i}a.object=t,E(a)},b,f)}function s(e){var a=new THREE.glTFLoader;a.load(e.url,function(a){var n=a.scene;e.object=n,E(e)},b,f)}function d(e){var a=new THREE.FBXLoader;a.load(e.url,function(a){e.object=a,E(e)},b,f())}function b(e){}function f(e){console.log("There was an error loading your object")}function E(a){null!=a.i?a.callback(a):a.callback(a.object),e.queue&&n(),console.log("UltimateLoader: Object "+a.name+" loaded!")}var g=[],m=0,v="anonymous";e.useQueue=!1,e.imageSize=32,e.loadImagesOnPlane=!1,e.load=function(n,r){e.useQueue?(a(n,r),t()):o(n,r)},e.multiload=function(n,r){for(var l=[],i=0,c=function(e){l[e.i]=e.object,i++,i==objUrls.length&&r(l)},u=0;u<n.length;u++){[n[u],c,u];e.useQueue?(a(n[u],c),t()):o(n[u],c,u)}}}(UltimateLoader);
