var UltimateLoader=UltimateLoader||{};!function(e){"use strict";function a(e,a,n){g.push([e,a,n])}function n(){if(v>g.length-1)return g=[],void(v=0);var e=g[v];v++,t(e[0],e[1],e[2])}function o(){0==v&&n()}function t(e,a,o){var t=r(e);switch(t.url=e,t.callback=a,null!=o&&(t.i=o),t.ext){case"obj":l(t);break;case"json":i(t);break;case"dae":c(t);break;case"gltf":s(t);break;case"fbx":d(t);break;case"drc":b(t);break;case"png":u(t);break;case"jpg":u(t);break;case"jpeg":u(t);break;default:console.log("UltimateLoader: File extension -"+t.ext+"- not recognized! Object -"+t.name+"- did not load."),n()}}function r(e){var a=e.slice(0,e.lastIndexOf("/")+1),n=e.substr(e.lastIndexOf("/")+1),o=n.split("."),t=o[0],r=o[o.length-1].toLowerCase(),l={name:t,ext:r,baseUrl:a};return l}function l(e){var a=e.name+".obj",n=e.name+".mtl",o=new THREE.MTLLoader;o.setPath(e.baseUrl),o.setTexturePath?o.setTexturePath(e.baseUrl):o.setBaseUrl(e.baseUrl),o.setCrossOrigin(T),o.load(n,function(n){n.preload();var o=new THREE.OBJLoader;o.setMaterials(n),o.setPath(e.baseUrl),o.load(a,function(a){e.object=a,E(e)},f,m)})}function i(e){var a=new THREE.ObjectLoader;a.load(e.url,function(a){e.object=a,E(e)},f,m)}function c(e){var a=new THREE.ColladaLoader;a.load(e.url,function(a){var n=a.scene;e.object=n,E(e)},f,m)}function u(a){var n=new THREE.TextureLoader;n.load(a.url,function(n){var o=n;if(e.loadImagesOnPlane){var t=n.image.naturalHeight/n.image.naturalWidth*e.imageSize,r=new THREE.PlaneGeometry(e.imageSize,t,e.imageSize),l=new THREE.MeshBasicMaterial({map:n,side:THREE.DoubleSide}),i=new THREE.Mesh(r,l);o=i}a.object=o,E(a)},f,m)}function s(e){var a=new THREE.glTFLoader;a.load(e.url,function(a){var n=a.scene;e.object=n,E(e)},f,m)}function d(e){var a=new THREE.FBXLoader;a.load(e.url,function(a){e.object=a,E(e)},f,m())}function b(e){var a=new THREE.DRACOLoader;a.load(e.url,function(a){var n=dracoLoader.decodeDracoFile(a);null==n.index?geometry=new THREE.Points(n,material):(n.computeVertexNormals(),geometry=new THREE.Mesh(n,material)),e.object=geometry,E(e)},f,m())}function f(e){}function m(e){console.log("There was an error loading your object")}function E(a){null!=a.i?a.callback(a):a.callback(a.object),e.useQueue&&n(),console.log("UltimateLoader: Object "+a.name+" loaded!")}var g=[],v=0,T="anonymous";e.useQueue=!1,e.imageSize=32,e.loadImagesOnPlane=!1,e.load=function(n,r){e.useQueue?(a(n,r),o()):t(n,r)},e.multiload=function(n,r){for(var l=[],i=0,c=function(e){l[e.i]=e.object,i++,i==n.length&&r(l)},u=0;u<n.length;u++)e.useQueue?(a(n[u],c,u),o()):t(n[u],c,u)}}(UltimateLoader);
